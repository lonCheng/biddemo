									...
									<div class="modal-dialog">
										<div class="modal-content">
											<div class="modal-header">
												...
												<h3 class="smaller lighter blue no-margin">打印</h3>
											</div>

											<div class="modal-body">
												<h3 class="center">打印【不予受理通知书】</h3>
						...
						<div class="row">
							...
							<form class="form-horizontal">
								  <div class="form-group">
								    <label for="" class="col-sm-1 control-label">流程类型</label>
								    <div class="col-sm-2">
								      <select class="form-control" id="form-field-select-1">
																<option value="all">全部</option>
																<option value="AL">内资开业登记</option>
																<option value="AK">内资变更登记</option>
																<option value="AZ">内资注销登记</option>
									</select>
								    </div>
								     <label for="" class="col-sm-1 control-label">移交类型</label>
								    <div class="col-sm-2">
								      <select class="form-control" id="form-field-select-1">
																<option value=""></option>
																<option value="AK">移交至人员</option>
																<option value="AK">移交至岗位</option>
									</select>
								    </div>
								     <label for="" class="col-sm-1 control-label">移交人</label>
								    <div class="col-sm-2">
								      <select class="form-control" id="form-field-select-1">
																<option value=""></option>
																<option value="AL">王中</option>
																<option value="AK">郭国</option>
																<option value="AZ">李台</option>
									</select>
								    </div>
								     <label for="" class="col-sm-1 control-label">接收标志</label>
								    <div class="col-sm-2">
								      <select class="form-control" id="form-field-select-1">
																<option value=""></option>
																<option value="AL">全部</option>
																<option value="AK">未接收</option>
																<option value="AZ">已接收</option>
									</select>
								    </div>
								  </div>
								 <div class="form-group">
											...
											<div class="widget-body">
												<div class="widget-main no-padding">
													<table class="table table-striped table-bordered table-hover">
														...
														<tbody>
															<tr>
																<td>01201704120003</td>
																<td class="">广州达成工程技术服务有限公司</td>
																...
																<td><span class="label" style="background-color:#00C78C;"></span></td>
																<td class="hidden-480">
																	<a href="../../mgr/information/editInput.jsp"><span class="label label-success arrowed-in arrowed-in-right">受理</span></a>
																	<a href="#my-modal" data-toggle="modal"><span class="label label-gray arrowed-in arrowed-in-right" >不受理</span></a>
																</td>
															</tr>
															<tr>
																<td>01201704120002</td>
																<td class="">广州城电客户服务有限公司</td>
															...
															<tr>
																<td>01201704120008</td>
																<td class="">广州中科服务有限公司</td>
															...
															<tr>
																<td>91201704123318</td>
																<td class="">广州金财服务有限公司</td>
