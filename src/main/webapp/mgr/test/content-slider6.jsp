													...
													<div class="tab-content profile-edit-tab-content">
														<div id="edit-basic" class="tab-pane in active">
															...
															<h4 class="header blue bolder smaller">股东基本信息</h4>
																...
																<div class="col-xs-12 col-sm-12">
																	<div class="form-group">
																		<label class="col-sm-1 control-label no-padding-right" for="form-field-username">投资人类型</label>
																		...
																		<label class="col-sm-1 control-label no-padding-right" for="form-field-username">证件编号</label>
