						...
						<div class="col-xs-12">
							<form class="form-horizontal">
								<div class="form-group">
									...
									<label for="" class="col-sm-1 control-label">责任人</label>
									<div class="col-sm-2">
										<input type="text" class="form-control" id=""
											placeholder="责任人">
									</div>
								...
								<div class="widget-box widget-color-blue">
									...
									<div class="widget-header">
										<h5 class="widget-title bigger lighter">
											<i class="ace-icon fa fa-table"></i> 业务处理跟踪
										</h5>
									</div>
											...
											<table class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														...
														<td>系统自动审批</td>
														<td>/pass.do</td>
														<td>系统自动审核通过企业[广州棒棒糖有限公司]的申请</td>
														<td>2017-04-30 17:12:34</td>
														<td>李时欣</td>
														<td>RZ612213112312131</td>
													</tr>
													<tr>
														<td>3</td>
														<td>gs00002</td>
														...
														<td>/lookZZ.do</td>
														<td>查看企业领照情况</td>
														<td>2017-05-01 17:12:34</td>
														<td>蒋大牛</td>
														<td>RZ61221398900000</td>
													</tr>
												</tbody>
											</table>
										</div>
