		...
		<div class="main-content">
			<div class="main-content-inner">
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-9 col-sm-10 col-sm-offset-1">
							<div class="container">
									...
									<div class="pricing-span-body ">
										<div class="pricing-span">
											...
											<div class="widget-box pricing-box-small widget-color-red3">
												<div class="widget-header">
													<h5 class="widget-title bigger lighter">公司</h5>
												</div>

												<div class="widget-body">
													<div class="widget-main no-padding">
														<ul class="list-unstyled list-striped pricing-table">
															<li><span><a href="setUpPage.jsp"
																	class="ace-icon glyphicon glyphicon-plus">设立</span></a></li>
															<li><span><a href="#"
																	class="ace-icon glyphicon glyphicon-pencil">变更（备案）</span></a></li>
															<li><span><a href="#"
																	class="ace-icon glyphicon glyphicon-off">注销</span></a></li>
										...
										<div class="pricing-span">
											<div class="widget-box pricing-box-small widget-color-orange">
												<div class="widget-header">
													<h5 class="widget-title bigger lighter">个人独资企业</h5>
												</div>
										...
										<div class="pricing-span">
											<div class="widget-box pricing-box-small widget-color-blue">
												<div class="widget-header">
													<h5 class="widget-title bigger lighter">合伙企业</h5>
												</div>
										...
										<div class="pricing-span">
											<div class="widget-box pricing-box-small widget-color-green">
												<div class="widget-header">
													<h5 class="widget-title bigger lighter">股权出质</h5>
												</div>
										...
										<div class="pricing-span">
											<div class="widget-box pricing-box-small widget-color-grey">
												<div class="widget-header">
													<h5 class="widget-title bigger lighter">非公司企业法人</h5>
												</div>
										...
										<div class="pricing-span">
											<div class="widget-box pricing-box-small widget-color-red3">
												<div class="widget-header">
													<h5 class="widget-title bigger lighter">分支机构</h5>
												</div>
