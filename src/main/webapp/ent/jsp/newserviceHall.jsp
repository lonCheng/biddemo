									...
									<li class=" item   col-sm-2">
										...
										<div class="item-head">
											<div class="item-head-default">
												...
												<div class="item-title">个人独资企业</div>
											</div>
											<div class="item-head-active">
												<div class="icon-wrapper">
													<div class="icon icon-private"></div>
										...
										<div class="item-content">
											<div class="item-content-default">
												<ul class="item-sub-content">
													...
													<li class="sub-item">
														<div class="sub-item-title">撤销</div>
													</li>
													<li class="sub-item">
														<div class="sub-item-title">注销</div>
													</li>
											...
											<div class="item-content-active">
												<ul class="item-sub-content">
													...
													<li class="sub-item clearfix">
														<div class="sub-item-title clearfix">变更</div> <a
														href="#"
														class="btn-more">开始办理</a>
													</li>
													<li class="sub-item clearfix">
														<div class="sub-item-title clearfix">撤销</div> <a
														href="#"
														class="btn-more">开始办理</a>
													</li>
													<li class="sub-item clearfix">
									...
									<li class=" item  col-sm-2">
										...
										<div class="item-head">
											<div class="item-head-default">
												...
												<div class="item-title">非公司企业法人</div>
											</div>
											<div class="item-head-active">
												<div class="icon-wrapper">
													<div class="icon icon-public"></div>
