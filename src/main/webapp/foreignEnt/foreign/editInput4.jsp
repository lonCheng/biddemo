...
<body class="no-skin">
 ...
 -->
																...
																<div class="form-group">
																	<label class="col-sm-1 control-label no-padding-right"
																		for="form-field-username">核算方式</label>
																	...
																	<div class="col-sm-3">
																		<select style="width: 150px;">
																			...
																			<option>独立核算</option>
																			<option>非独立核算</option>
																		</select> <font color="red">注明：限分公司、营业单位、个人独资（合伙）企业分支机构、外资企业分支机构、农民专业合作社分支机构录入
																		</font>
																	</div>
																	...
																	<div class="col-sm-6">
																		...
																		</select><font color="red">注明：“外资企业分支机构负责人”录入</font>
																	</div>
																</div>
															...
															<div class="col-xs-12 col-sm-12">
																<div class="form-group">
																	...
																	<div class="col-sm-3">
																		<span class="input-icon input-icon-right"> <input
																			class="input-medium input-mask-phone" type="text"
																			id="form--phone" style="width: 175px;" /> <i
																			class="ace-icon fa fa-phone fa-flip-horizontal"></i>
																		</span>
																	</div>
																...
																<div class="form-group">
																	...
																	<div class="col-sm-3">
																		<span class="input-icon input-icon-right"> <input
																			type="email" id="form-field-email" value=""
																			style="width: 175px;" /> <i
													...
													<div style="overflow:;" id="collapseFour">
														<h4 class="header blue bolder smaller">法定代表人\负责人\执行事务合伙人信息
														</h4>
