											...
											<div class="tab-content profile-edit-tab-content">
												<div id="edit-basic" class="tab-pane in active">
														...
														<div class="row">
															<div class="col-xs-12 col-sm-12">
																<div class="form-group">
																	...
																	<label class="col-sm-1 control-label no-padding-right"
																		for="form-field-username">出生日期</label>
																...
																<div class="form-group">
																	...
																	<div class="col-sm-3">
																		<select class="tc-15-select" data-bind="value: ZS2"
																			...
																			<option value=""></option>
																			<option value="海珠区">居民身份证</option>
																			<option value="越秀区">军官证</option>
																			<option value="荔湾区">警官证</option>
																			<option value="天河区">外国（地区）护照</option>
																			<option value="白云区">港澳居民身份证</option>
																			<option value="黄埔区">回乡证</option>
																			<option value="花都区">台胞证</option>
																			<option value="番禺区">其他有效身份证</option>
																			<option value="萝岗区">台湾居民身份证</option>
																...
																<div class="form-group">
																	...
																	<label class="col-sm-1 control-label no-padding-right"
																		for="form-field-username">地址</label>
																...
																<div class="form-group">
																	...
																	<label class="col-sm-1 control-label no-padding-right"
																		for="form-field-username">许可经营事项 </label>
													...
													<div style="overflow:;" id="collapseFive">
															<div class="row">
																<div class="widget-header widget-header-blue widget-header-flat" align="center">
																&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	<button type="button" class="btn btn-primary" style="" onclick="javascript:window.location.href='editInput2.jsp'">上一步</button>
																&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	<button type="button" class="btn btn-primary" style="" onclick="javascript:window.location.href='editInput4.jsp'">下一步</button>
