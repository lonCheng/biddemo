											...
											<div class="tab-content profile-edit-tab-content">
												<div id="edit-basic" class="tab-pane in active">
													<div style="overflow:;" id="collapseOne">
														<h4 class="header blue bolder smaller">纸质材料7</h4>
															<h5>分公司的主营项目类别和经营范围不得超出公司的经营范围。经营范围涉及广州市前置许可审批事项的［可登录广州红盾信息网站（http://www.gzaic.gov.cn/）进行查询］，提交有关批准文件或许可证复印件。</h5>
														<div class="row">
													...
													<div style="overflow:;" id="collapseFive">
														<div class="row">
															<div
																...
																align="center">
																&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
																<button type="button" class="btn btn-primary" style="" onclick="javascript:window.location.href='editInput10.jsp'">上一步</button>
																&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
																<button type="button" class="btn btn-primary" style="" onclick="javascript:window.location.href='editInput12.jsp'">下一步</button>
																&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
