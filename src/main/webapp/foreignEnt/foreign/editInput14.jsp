	...
	<div id="NavTop">
		<div id="NavCon">
			<ul>
				...
				<li><a href="javascript:return false;">纸质材料</a></li>
			</ul>
								...
								<div class="col-sm-offset-0 col-sm-11">
									...
									<div class="col-sm-12">
										<h3 class="row header smaller lighter blue">
											<span class="col-xs-12"> 纸质材料 </span><!-- /.col -->
										</h3>
																					...
																					<div class="form-group">
																						<div class="col-xs-12">
																							<input multiple="" type="file"
																								id="id-input-file-8" accept="image/*" />
												...
												<div class="panel-heading">
													<h4 class="panel-title">
														<a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseSeven">
															<i class="ace-icon fa fa-angle-right bigger-110" data-icon-hide="ace-icon fa fa-angle-down" data-icon-show="ace-icon fa fa-angle-right"></i>
															&nbsp;《法定代表人（负责人）信息表》、公司出具的分公司负责人任职文件及身份证件复印件
														</a>
													</h4>
												</div>
												...
												<div class="panel-heading">
													<h4 class="panel-title">
														<a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseEight">
															<i class="ace-icon fa fa-angle-right bigger-110" data-icon-hide="ace-icon fa fa-angle-down" data-icon-show="ace-icon fa fa-angle-right"></i>
															&nbsp;分公司的主营项目类别和经营范围不得超出公司的经营范围。经营范围涉及广州市前置许可审批事项的［可登录广州红盾信息网站（http://www.gzaic.gov.cn/）进行查询］，提交有关批准文件或许可证复印件。
														</a>
													</h4>
												</div>
													...
													<div style="overflow:;" id="collapseFive">
														<div class="row">
															<div
																...
																>
																&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
																<button type="button" class="btn btn-primary" style="">提交</button>
															</div>
														</div>
