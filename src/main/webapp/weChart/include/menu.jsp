				...
				<ul class="nav nav-list">
					...
					<li class="">
						...
						<ul class="submenu">
							...
							<li class="<%if(requestPage.equals("/weChart/information/moveEnt.jsp")){%>active<%}%>">
								<a href="../../weChart/information/moveEnt.jsp">
									<i class="menu-icon fa fa-caret-right"></i>
									迁移（广州市内）
								</a>
							...
							<li class="<%if(requestPage.equals("/weChart/information/normalZxEnt.jsp")){%>active<%}%>">
								<a href="../../weChart/information/normalZxEnt.jsp">
									<i class="menu-icon fa fa-caret-right"></i>
									一般注销
								</a>
