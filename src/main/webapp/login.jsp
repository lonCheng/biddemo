...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>广州市工商行政管理局-商事登记全程电子化系统</title>
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="red">广州市工商行政管理局</span>
									<!-- <span class="white" id="id-text2">商事登记全程电子化系统</span> -->
								</h1>
								<h2 class="blue" id="id-company-text">商事登记全程电子化系统</h2>
							</div>
									...
									<div class="widget-body">
										<div class="widget-main">
											...
											<!-- <div class="social-or-login center">
												<span class="bigger-110">通过其它方式登录</span>
											</div>
